 ...
 */
public class PollingImplementation {

    /**
     * Demonstrates basic usage of the Polling pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic Polling pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced Polling pattern...");

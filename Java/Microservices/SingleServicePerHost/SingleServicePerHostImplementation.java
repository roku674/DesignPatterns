...
/**
 * SingleServicePerHost Pattern Implementation
 *
 * Deploy one service instance per host
 */
public class SingleServicePerHostImplementation {

    /**
     * Demonstrates basic usage of the SingleServicePerHost pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic SingleServicePerHost pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced SingleServicePerHost pattern...");

...
/**
 * ExternalizedConfiguration Pattern Implementation
 *
 * Stores configuration outside of service code
 */
public class ExternalizedConfigurationImplementation {

    /**
     * Demonstrates basic usage of the ExternalizedConfiguration pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic ExternalizedConfiguration pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced ExternalizedConfiguration pattern...");

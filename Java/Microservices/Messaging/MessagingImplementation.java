 ...
 */
public class MessagingImplementation {

    /**
     * Demonstrates basic usage of the Messaging pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic Messaging pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced Messaging pattern...");

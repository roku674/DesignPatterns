...
/**
 * ServerSideLoadBalancing Pattern Implementation
 *
 * Dedicated load balancer distributes traffic
 */
public class ServerSideLoadBalancingImplementation {

    /**
     * Demonstrates basic usage of the ServerSideLoadBalancing pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic ServerSideLoadBalancing pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced ServerSideLoadBalancing pattern...");

...
/**
 * ServiceComponent Pattern Implementation
 *
 * Package service as deployable component
 */
public class ServiceComponentImplementation {

    /**
     * Demonstrates basic usage of the ServiceComponent pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic ServiceComponent pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced ServiceComponent pattern...");

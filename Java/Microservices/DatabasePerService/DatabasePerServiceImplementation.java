...
/**
 * DatabasePerService Pattern Implementation
 *
 * Each service has its own private database
 */
public class DatabasePerServiceImplementation {

    /**
     * Demonstrates basic usage of the DatabasePerService pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic DatabasePerService pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced DatabasePerService pattern...");

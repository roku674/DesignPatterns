...
/**
 * MultipleServicesPerHost Pattern Implementation
 *
 * Deploy multiple service instances on single host
 */
public class MultipleServicesPerHostImplementation {

    /**
     * Demonstrates basic usage of the MultipleServicesPerHost pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic MultipleServicesPerHost pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced MultipleServicesPerHost pattern...");

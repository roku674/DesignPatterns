 ...
 *
 * This implementation demonstrates the BackendForFrontend pattern
...
public class Main {
    ...
    private static void demonstrateBasicUsage() {
        System.out.println("1. Basic BackendForFrontend Usage");
        System.out.println("-".repeat(50));

        BackendForFrontendImplementation impl = new BackendForFrontendImplementation();
        impl.executeBasic();
        System.out.println();
    }

    private static void demonstrateAdvancedUsage() {
        System.out.println("2. Advanced BackendForFrontend Usage");
        System.out.println("-".repeat(50));

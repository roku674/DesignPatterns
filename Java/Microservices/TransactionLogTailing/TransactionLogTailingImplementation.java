...
/**
 * TransactionLogTailing Pattern Implementation
 *
 * Publishes database changes by tailing transaction log
 */
public class TransactionLogTailingImplementation {

    /**
     * Demonstrates basic usage of the TransactionLogTailing pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic TransactionLogTailing pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced TransactionLogTailing pattern...");

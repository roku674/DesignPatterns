 ...
 *
 * This implementation demonstrates the ServiceRegistry pattern
...
public class Main {
    ...
    private static void demonstrateBasicUsage() {
        System.out.println("1. Basic ServiceRegistry Usage");
        System.out.println("-".repeat(50));

        ServiceRegistryImplementation impl = new ServiceRegistryImplementation();
        impl.executeBasic();
        System.out.println();
    }

    private static void demonstrateAdvancedUsage() {
        System.out.println("2. Advanced ServiceRegistry Usage");
        System.out.println("-".repeat(50));

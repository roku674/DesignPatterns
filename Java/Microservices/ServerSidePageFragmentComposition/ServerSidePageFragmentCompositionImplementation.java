...
/**
 * ServerSidePageFragmentComposition Pattern Implementation
 *
 * Server composes UI from multiple fragments
 */
public class ServerSidePageFragmentCompositionImplementation {

    /**
     * Demonstrates basic usage of the ServerSidePageFragmentComposition pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic ServerSidePageFragmentComposition pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced ServerSidePageFragmentComposition pattern...");

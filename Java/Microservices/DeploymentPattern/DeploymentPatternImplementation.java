...
/**
 * DeploymentPattern Pattern Implementation
 *
 * Strategies for deploying microservices
 */
public class DeploymentPatternImplementation {

    /**
     * Demonstrates basic usage of the DeploymentPattern pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic DeploymentPattern pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced DeploymentPattern pattern...");

...
/**
 * DistributedTracing Pattern Implementation
 *
...
public class DistributedTracingImplementation {
    ...
    /**
     * Demonstrates basic usage of the DistributedTracing pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic DistributedTracing pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced DistributedTracing pattern...");

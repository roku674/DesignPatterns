...
/**
 * EventDrivenArchitecture Pattern Implementation
 *
 * System behavior driven by production and consumption of events
 */
public class EventDrivenArchitectureImplementation {

    /**
     * Demonstrates basic usage of the EventDrivenArchitecture pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic EventDrivenArchitecture pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced EventDrivenArchitecture pattern...");

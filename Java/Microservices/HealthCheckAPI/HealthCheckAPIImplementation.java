...
/**
 * HealthCheckAPI Pattern Implementation
 *
 * Service exposes health check endpoint
 */
public class HealthCheckAPIImplementation {

    /**
     * Demonstrates basic usage of the HealthCheckAPI pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic HealthCheckAPI pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced HealthCheckAPI pattern...");

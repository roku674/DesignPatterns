...
/**
 * SelfRegistration Pattern Implementation
 *
 * Service instances register themselves with service registry
 */
public class SelfRegistrationImplementation {

    /**
     * Demonstrates basic usage of the SelfRegistration pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic SelfRegistration pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced SelfRegistration pattern...");

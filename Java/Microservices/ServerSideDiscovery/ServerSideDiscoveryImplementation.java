...
/**
 * ServerSideDiscovery Pattern Implementation
 *
 * Router queries service registry and forwards requests
 */
public class ServerSideDiscoveryImplementation {

    /**
     * Demonstrates basic usage of the ServerSideDiscovery pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic ServerSideDiscovery pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced ServerSideDiscovery pattern...");

 ...
 *
 * This implementation demonstrates the RemoteProcedureInvocation pattern
...
public class Main {
    ...
    private static void demonstrateBasicUsage() {
        System.out.println("1. Basic RemoteProcedureInvocation Usage");
        System.out.println("-".repeat(50));

        RemoteProcedureInvocationImplementation impl = new RemoteProcedureInvocationImplementation();
        impl.executeBasic();
        System.out.println();
    }

    private static void demonstrateAdvancedUsage() {
        System.out.println("2. Advanced RemoteProcedureInvocation Usage");
        System.out.println("-".repeat(50));

...
/**
 * ThirdPartyRegistration Pattern Implementation
 *
 * External registrar handles service registration
 */
public class ThirdPartyRegistrationImplementation {

    /**
     * Demonstrates basic usage of the ThirdPartyRegistration pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic ThirdPartyRegistration pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced ThirdPartyRegistration pattern...");

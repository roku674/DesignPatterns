...
/**
 * TransactionalOutbox Pattern Implementation
 *
 * Publishes events as part of database transaction
 */
public class TransactionalOutboxImplementation {

    /**
     * Demonstrates basic usage of the TransactionalOutbox pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic TransactionalOutbox pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced TransactionalOutbox pattern...");

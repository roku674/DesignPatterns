...
/**
 * ConsumerDrivenContract Pattern Implementation
 *
 * Consumer defines contract for provider services
 */
public class ConsumerDrivenContractImplementation {

    /**
     * Demonstrates basic usage of the ConsumerDrivenContract pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic ConsumerDrivenContract pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced ConsumerDrivenContract pattern...");

...
/**
 * ClientSideDiscovery Pattern Implementation
 *
 * Client queries service registry and performs load balancing
 */
public class ClientSideDiscoveryImplementation {

    /**
     * Demonstrates basic usage of the ClientSideDiscovery pattern
     */
    public void executeBasic() {
        System.out.println("Executing basic ClientSideDiscovery pattern...");
    ...
    public void executeAdvanced() {
        System.out.println("Executing advanced ClientSideDiscovery pattern...");

...
## Overview
The SmartProxy pattern is a core Enterprise Integration Pattern that enables
tracks messages sent through proxy and returns response. This pattern is essential for building robust, scalable,
...
Use the SmartProxy pattern when:
...
Initializing SmartProxy infrastructure...
  ℹ SmartProxy instance [ID] initialized
  ✓ Infrastructure initialized

────────────────────────────────────────────────────────────────────────
Scenario 1: Request tracking
────────────────────────────────────────────────────────────────────────
Description: Track request-response

  → Processing: Request tracking
  ℹ Created message: [MESSAGE-ID]
  → Executing SmartProxy logic...
  ✓ Pattern logic executed for: Request tracking
...
- Demonstrates all key concepts of the SmartProxy pattern
...
SmartProxy pattern from Enterprise Integration Patterns.

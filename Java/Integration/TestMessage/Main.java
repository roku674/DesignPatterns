...
/**
 * TestMessage Pattern - Enterprise Integration Pattern
 *
 * Category: System Management
 *
 * Intent:
 * Sends test messages to verify system functionality
 *
 * Key Concepts:
 * - System testing
 * - Health verification
 ...
 *
 * When to Use:
 * - You need to implement sends test messages to verify system functionality
 ...
 * 2. Smoke tests: Quick functionality test
 * 3. Integration testing: Test integrations
 * 4. Canary testing: Test new deployments
 * 5. Load testing: Generate test load
 *
...
public class Main {
    ...
    private static final String PATTERN_NAME = "TestMessage";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("  Sends test messages to verify system functionality");
        System.out.println();

        // Initialize the pattern
        System.out.println("Initializing TestMessage infrastructure...");
        TestMessageImplementation implementation = new TestMessageImplementation();
        System.out.println("  ✓ Infrastructure initialized");
        System.out.println();

        // Scenario 1: Health checks
        demonstrateScenario("Health checks", "Verify system health", implementation);

        // Scenario 2: Smoke tests
        demonstrateScenario("Smoke tests", "Quick functionality test", implementation);

        // Scenario 3: Integration testing
        demonstrateScenario("Integration testing", "Test integrations", implementation);

        // Scenario 4: Canary testing
        demonstrateScenario("Canary testing", "Test new deployments", implementation);

        // Scenario 5: Load testing
        demonstrateScenario("Load testing", "Generate test load", implementation);
    ...
    private static void demonstrateScenario(
            ...
            TestMessageImplementation implementation) {

...
## Overview
The WireTap pattern is a core Enterprise Integration Pattern that enables
monitors messages on channel by tapping into the channel. This pattern is essential for building robust, scalable,
...
Initializing WireTap infrastructure...
  ℹ WireTap instance [ID] initialized
...
Description: Log all messages
  ...
  → Executing WireTap logic...
  ✓ Pattern logic executed for: Audit logging
...
- Demonstrates all key concepts of the WireTap pattern
...
WireTap pattern from Enterprise Integration Patterns.

 ...
 *
 * When to Use:
 * - You need to implement combines multiple related messages into a single message
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        demonstrateScenario("Order aggregation", "Combine order items into single order", implementation);

        // Scenario 2: Price quotes
        demonstrateScenario("Price quotes", "Aggregate quotes from multiple vendors", implementation);

        // Scenario 3: Survey responses
        demonstrateScenario("Survey responses", "Combine responses into results", implementation);

        // Scenario 4: Batch completion
        demonstrateScenario("Batch completion", "Wait for all batch items", implementation);

        // Scenario 5: Parallel results
        demonstrateScenario("Parallel results", "Combine parallel API call results", implementation);
    ...
    private static void demonstrateScenario(
            ...
            AggregatorImplementation implementation) {

...
## Overview
The PollingConsumer pattern is a core Enterprise Integration Pattern that enables
consumer explicitly polls for messages rather than event-driven receipt. This pattern is essential for building robust, scalable,
...
Use the PollingConsumer pattern when:
...
```
┌──────────────┐       ┌──────────────────────┐       ┌──────────────┐
│   Sender     │──────>│  PollingConsumer       │──────>│   Receiver   │
...
Poll when resources available

### 5. Manual processing
Explicit message retrieval
...
Initializing PollingConsumer infrastructure...
  ℹ PollingConsumer instance [ID] initialized
  ✓ Infrastructure initialized

────────────────────────────────────────────────────────────────────────
Scenario 1: Batch processing
────────────────────────────────────────────────────────────────────────
Description: Poll for batch of messages

  → Processing: Batch processing
  ℹ Created message: [MESSAGE-ID]
  → Executing PollingConsumer logic...
  ✓ Pattern logic executed for: Batch processing
...
- Demonstrates all key concepts of the PollingConsumer pattern
...
PollingConsumer pattern from Enterprise Integration Patterns.

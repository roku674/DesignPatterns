...
## Overview
The Splitter pattern is a core Enterprise Integration Pattern that enables
breaks a single message into multiple messages. This pattern is essential for building robust, scalable,
...
### 5. Address list
Split mailing list for processing
...
Initializing Splitter infrastructure...
  ℹ Splitter instance [ID] initialized
  ✓ Infrastructure initialized

────────────────────────────────────────────────────────────────────────
Scenario 1: Batch order processing
────────────────────────────────────────────────────────────────────────
Description: Split batch into individual orders

  → Processing: Batch order processing
  ℹ Created message: [MESSAGE-ID]
  → Executing Splitter logic...
  ✓ Pattern logic executed for: Batch order processing
...
- Demonstrates all key concepts of the Splitter pattern
...
Splitter pattern from Enterprise Integration Patterns.

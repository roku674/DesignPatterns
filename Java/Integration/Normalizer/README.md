...
## Overview
The Normalizer pattern is a core Enterprise Integration Pattern that enables
transforms messages from different sources into common format. This pattern is essential for building robust, scalable,
...
Use the Normalizer pattern when:
...
Convert XML, JSON, CSV to common format
...
### 4. API versioning
Normalize different API versions

### 5. Protocol normalization
Convert protocols to standard
...
Initializing Normalizer infrastructure...
  ℹ Normalizer instance [ID] initialized
  ✓ Infrastructure initialized

────────────────────────────────────────────────────────────────────────
Scenario 1: Data format unification
────────────────────────────────────────────────────────────────────────
Description: Convert XML, JSON, CSV to common format

  → Processing: Data format unification
  ℹ Created message: [MESSAGE-ID]
  → Executing Normalizer logic...
  ✓ Pattern logic executed for: Data format unification
...
- Demonstrates all key concepts of the Normalizer pattern
...
Normalizer pattern from Enterprise Integration Patterns.

...
## Overview
The DynamicRouter pattern is a core Enterprise Integration Pattern that enables
routes messages based on runtime configuration that can change dynamically. This pattern is essential for building robust, scalable,
...
Use the DynamicRouter pattern when:
...
### 1. Feature flags
Route to new service version based on flags

### 2. Load balancing
Dynamic routing based on server load

### 3. Maintenance mode
Route around services under maintenance

### 4. A/B testing
Route percentage of traffic to test version
...
Initializing DynamicRouter infrastructure...
  ℹ DynamicRouter instance [ID] initialized
  ✓ Infrastructure initialized

────────────────────────────────────────────────────────────────────────
Scenario 1: Feature flags
────────────────────────────────────────────────────────────────────────
Description: Route to new service version based on flags

  → Processing: Feature flags
  ℹ Created message: [MESSAGE-ID]
  → Executing DynamicRouter logic...
  ✓ Pattern logic executed for: Feature flags
...
- Demonstrates all key concepts of the DynamicRouter pattern
...
DynamicRouter pattern from Enterprise Integration Patterns.

---

**Pattern**: DynamicRouter
**Category**: Message Routing

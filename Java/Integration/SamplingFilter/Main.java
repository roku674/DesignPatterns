...
/**
 * SamplingFilter Pattern - Enterprise Integration Pattern
 *
 * Category: Message Filtering
 *
 * Intent:
 * Passes only a sample of messages through
 *
 * Key Concepts:
 ...
 *
 * When to Use:
 * - You need to implement passes only a sample of messages through
 ...
 * 1. Metrics sampling: Sample for metrics
 * 2. Load testing: Sample during high load
 * 3. Analytics: Sample for analysis
 * 4. Debugging: Sample for debugging
 * 5. Monitoring: Sample for monitoring
 *
...
public class Main {
    ...
    private static final String PATTERN_NAME = "SamplingFilter";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("  Passes only a sample of messages through");
        System.out.println();

        // Initialize the pattern
        System.out.println("Initializing SamplingFilter infrastructure...");
        SamplingFilterImplementation implementation = new SamplingFilterImplementation();
        System.out.println("  ✓ Infrastructure initialized");
        System.out.println();

        // Scenario 1: Metrics sampling
        demonstrateScenario("Metrics sampling", "Sample for metrics", implementation);

        // Scenario 2: Load testing
        demonstrateScenario("Load testing", "Sample during high load", implementation);

        // Scenario 3: Analytics
        demonstrateScenario("Analytics", "Sample for analysis", implementation);

        // Scenario 4: Debugging
        demonstrateScenario("Debugging", "Sample for debugging", implementation);

        // Scenario 5: Monitoring
        demonstrateScenario("Monitoring", "Sample for monitoring", implementation);
    ...
    private static void demonstrateScenario(
            ...
            SamplingFilterImplementation implementation) {

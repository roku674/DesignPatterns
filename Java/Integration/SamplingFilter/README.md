...
## Overview
The SamplingFilter pattern is a core Enterprise Integration Pattern that enables
passes only a sample of messages through. This pattern is essential for building robust, scalable,
...
Use the SamplingFilter pattern when:
...
```
┌──────────────┐       ┌──────────────────────┐       ┌──────────────┐
│   Sender     │──────>│  SamplingFilter       │──────>│   Receiver   │
...
Initializing SamplingFilter infrastructure...
  ℹ SamplingFilter instance [ID] initialized
  ✓ Infrastructure initialized

────────────────────────────────────────────────────────────────────────
Scenario 1: Metrics sampling
────────────────────────────────────────────────────────────────────────
Description: Sample for metrics

  → Processing: Metrics sampling
  ℹ Created message: [MESSAGE-ID]
  → Executing SamplingFilter logic...
  ✓ Pattern logic executed for: Metrics sampling
...
- Demonstrates all key concepts of the SamplingFilter pattern
...
SamplingFilter pattern from Enterprise Integration Patterns.

---

**Pattern**: SamplingFilter
**Category**: Message Filtering

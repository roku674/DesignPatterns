...
/**
 * ContentBasedFilter Pattern - Enterprise Integration Pattern
 *
 * Category: Message Filtering
 *
 * Intent:
 * Filters messages based on content criteria
 *
 * Key Concepts:
 * - Content inspection
 ...
 *
 * When to Use:
 * - You need to implement filters messages based on content criteria
 ...
 * 1. Spam filtering: Filter spam messages
 * 2. Priority filtering: Filter by priority
 * 3. Region filtering: Filter by region
 * 4. Type filtering: Filter by message type
 * 5. Quality filtering: Filter low-quality messages
 *
...
public class Main {
    ...
    private static final String PATTERN_NAME = "ContentBasedFilter";
    private static int scenarioCounter = 0;

    public static void main(String[] args) {
        System.out.println("╔" + "═".repeat(70) + "╗");
        System.out.println("║  " + PATTERN_NAME + " Pattern Demonstration" + " ".repeat(70 - PATTERN_NAME.length() - 32) + "║");
        System.out.println("║  Category: Message Filtering" + " ".repeat(70 - 13 - len(category)) + "║");
        System.out.println("╚" + "═".repeat(70) + "╝");
        System.out.println();

        // Pattern description
        System.out.println("Description:");
        System.out.println("  Filters messages based on content criteria");
        System.out.println();

        // Initialize the pattern
        System.out.println("Initializing ContentBasedFilter infrastructure...");
        ContentBasedFilterImplementation implementation = new ContentBasedFilterImplementation();
        System.out.println("  ✓ Infrastructure initialized");
        System.out.println();

        // Scenario 1: Spam filtering
        demonstrateScenario("Spam filtering", "Filter spam messages", implementation);

        // Scenario 2: Priority filtering
        demonstrateScenario("Priority filtering", "Filter by priority", implementation);

        // Scenario 3: Region filtering
        demonstrateScenario("Region filtering", "Filter by region", implementation);

        // Scenario 4: Type filtering
        demonstrateScenario("Type filtering", "Filter by message type", implementation);

        // Scenario 5: Quality filtering
        demonstrateScenario("Quality filtering", "Filter low-quality messages", implementation);
    ...
    private static void demonstrateScenario(
            ...
            ContentBasedFilterImplementation implementation) {

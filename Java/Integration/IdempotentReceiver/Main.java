...
/**
 * IdempotentReceiver Pattern - Enterprise Integration Pattern
 *
 ...
 *
 * When to Use:
 * - You need to implement ensures duplicate messages are processed only once
 ...
 * 1. Payment processing: Process payment once
 * 2. Order creation: Create order once
 * 3. Inventory updates: Update once
 * 4. Email sending: Send once
 * 5. Database updates: Update once
 *
...
public class Main {
    ...
    private static final String PATTERN_NAME = "IdempotentReceiver";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("  Ensures duplicate messages are processed only once");
        System.out.println();

        // Initialize the pattern
        System.out.println("Initializing IdempotentReceiver infrastructure...");
        ...
        demonstrateScenario("Payment processing", "Process payment once", implementation);

        // Scenario 2: Order creation
        demonstrateScenario("Order creation", "Create order once", implementation);

        // Scenario 3: Inventory updates
        demonstrateScenario("Inventory updates", "Update once", implementation);

        // Scenario 4: Email sending
        demonstrateScenario("Email sending", "Send once", implementation);

        // Scenario 5: Database updates
        demonstrateScenario("Database updates", "Update once", implementation);
    ...
    private static void demonstrateScenario(
            ...
            IdempotentReceiverImplementation implementation) {

...
/**
 * CompetingConsumersPattern Pattern - Enterprise Integration Pattern
 *
 ...
 *
 * When to Use:
 * - You need to implement multiple consumers compete to process messages from same channel
 ...
 * 1. Order processing: Multiple order processors
 * 2. Job processing: Distributed job workers
 * 3. Email sending: Multiple email senders
 * 4. Image processing: Parallel image processors
 * 5. Data import: Concurrent importers
 *
...
public class Main {
    ...
    private static final String PATTERN_NAME = "CompetingConsumersPattern";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("  Multiple consumers compete to process messages from same channel");
        System.out.println();

        // Initialize the pattern
        System.out.println("Initializing CompetingConsumersPattern infrastructure...");
        ...
        demonstrateScenario("Order processing", "Multiple order processors", implementation);

        // Scenario 2: Job processing
        demonstrateScenario("Job processing", "Distributed job workers", implementation);

        // Scenario 3: Email sending
        demonstrateScenario("Email sending", "Multiple email senders", implementation);

        // Scenario 4: Image processing
        demonstrateScenario("Image processing", "Parallel image processors", implementation);

        // Scenario 5: Data import
        demonstrateScenario("Data import", "Concurrent importers", implementation);
    ...
    private static void demonstrateScenario(
            ...
            CompetingConsumersPatternImplementation implementation) {
